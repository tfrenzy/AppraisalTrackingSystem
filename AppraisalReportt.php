...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td width="438" height="50" align="center" valign="bottom" nowrap="nowrap" class="style2" id="logo">Appraisal Reports</td>
    <td width="258">&nbsp;</td>
  </tr>
 ...
 <tr>
   ...
   <table border="0" cellspacing="0" cellpadding="2" width="504">
        <tr>
          <td class="pageName style1">Click to view Appraisal Report</td>
        </tr>
        <tr>
          <td class="bodyText">
          <?php
		  ...
		  ?>
          <p><a href="AppraisalReport.php?xdate=<?php echo mysql_result($result, $i, "DateOfInterview"); $_SESSION['dater'] = $dates;?>">Interview of <?php echo mysql_result($result, $i, "DateOfInterview"); ?></a></p>
         <?php
		  }
		  ?>
          </td>
